...
# Metrics
REQUEST_COUNT = Counter('phishing_requests_total', 'Total requests', ['method', 'endpoint', 'status'])
REQUEST_DURATION = Histogram('phishing_request_duration_seconds', 'Request duration')
CLASSIFICATION_COUNT = Counter('phishing_classifications_total', 'Classifications by result', ['classification'])
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=os.getenv("ALLOWED_ORIGINS", "https://*.googleapis.com,https://*.google.com").split(","),
