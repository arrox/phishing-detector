...
class HeaderAnalyzer:
    ...
    def __init__(self):
        self.suspicious_tlds = {
            '.tk', '.ml', '.ga', '.cf', '.click', '.download', '.bid', 
            '.loan', '.racing', '.accountant', '.science', '.work'
        }
    ...
    def analyze_headers(self, raw_headers: str) -> Tuple[HeaderFindings, Dict]:
        ...
        try:
            ...
            findings.spf_dkim_dmarc = self._get_auth_status(spf_result, dkim_result, dmarc_result)
    ...
    def _get_auth_status(self, spf: SPFResult, dkim: DKIMResult, dmarc: DMARCResult) -> str:
        """Determine overall authentication status."""
    ...
    def _analyze_received_chain(self, msg: email.message.Message, details: Dict) -> bool:
        ...
        for received in received_headers:
            ...
            if re.search(r'\b(?:127\.|192\.168\.|10\.|172\.(?:1[6-9]|2[0-9]|3[0-1])\.)', received):
                suspicious_indicators += 1
