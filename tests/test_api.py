...
class TestPhishingAPI:
    ...
    def test_classify_endpoint_success(self, client, auth_headers, sample_phishing_request):
        ...
        with patch("src.app.detection_service") as mock_service:
            ...
            response = client.post(
                "/classify", 
                json=sample_phishing_request.dict(),
    ...
    def test_classify_endpoint_service_unavailable(self, client, auth_headers, sample_phishing_request):
    ...
    def test_classify_endpoint_internal_error(self, client, auth_headers, sample_phishing_request):
        """Test classification with internal error."""
        with patch("src.app.detection_service") as mock_service:
            mock_service.classify_email = AsyncMock(side_effect=Exception("Internal error"))
    ...
    def test_response_format(self, client, auth_headers, sample_phishing_request):
        ...
        with patch("src.app.detection_service") as mock_service:
            ...
            required_fields = [
                "classification", "risk_score", "top_reasons", 
                "non_technical_summary", "recommended_actions", 
                "evidence", "latency_ms"
            ]
