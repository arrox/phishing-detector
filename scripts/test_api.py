...
def run_test_suite():
    ...
    try:
        ...
        print(f"📊 Cargados {sum(len(cases) for cases in test_cases.values())} casos de prueba")
    except Exception as e:
    ...
    for category, cases in test_cases.items():
        ...
        print(f"📈 {category}: {category_results['passed']}/{category_results['total']} pruebas pasaron")
    ...
    print(f"✅ Pruebas exitosas: {results['passed']}/{results['total']} ({success_rate:.1f}%)")
